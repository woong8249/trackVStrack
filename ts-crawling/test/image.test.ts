...
const sameImageList = [
  ...
  ['https://image.bugsm.co.kr/artist/images/200/803473/80347326.jpg?version=20240525002108.0', 'https://www.melon.com/artist/timeline.htm?artistId=2899555'],
...
describe('Test func compareImages', () => {
  test.each(sameImageList)('Compare two similar images. The raw MisMatch Percentage will be less than 20.', async (a, b) => {
    ...
    console.log(rawMisMatchPercentage);
